...
// CORE SERVICES
// ═══════════════════════════════════════════════
// Configures Controllers globally with your Audit Filter
builder.Services.AddControllers(options =>
{
    options.Filters.Add<AuditLogFilter>();
});
...
// ═══════════════════════════════════════════════
// APPLICATION & INFRASTRUCTURE SERVICES (M6/M7)
// ═══════════════════════════════════════════════
builder.Services.AddScoped<IEnrollmentService, EnrollmentService>();
builder.Services.AddScoped<ICourseService, CourseService>();
// Inside Program.cs, register the implementation of these repository interfaces
builder.Services.AddScoped<ICourseRepository, CourseRepository>();
builder.Services.AddScoped<IEnrollmentRepository, EnrollmentRepository>();
builder.Services.AddSingleton<EnrollmentWorker>();

// ═══════════════════════════════════════════════
// EXERCISE 1: API VERSIONING SERVICES
// ═══════════════════════════════════════════════
builder.Services.AddApiVersioning(options =>
{
    options.DefaultApiVersion = new ApiVersion(1, 0);
...
// ═══════════════════════════════════════════════
// EXERCISE 2: MEDIATR & FLUENT VALIDATION REGISTRATION
// ═══════════════════════════════════════════════
...
// Register Pipeline Behaviors (Logging runs before Validation wraps requests)
...
// Catches unhandled exceptions → clean RFC 7807 ProblemDetails
app.UseExceptionHandler();

// Fills empty error responses (e.g. 404, 401) with ProblemDetails body
app.UseStatusCodePages();
...
// Deprecation headers injection for deprecated API versions (e.g. V1)
app.UseMiddleware<V1DeprecationMiddleware>();
...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!context.Students.Any())
    {
        ...
        var students = new List<Student>
        {
            ...
            new() { RegistrationNumber = "TMS-2026-0006", Name = "Joe Doe",          GPA = 4.00m, IsActive = true  },
            new() { RegistrationNumber = "TMS-2026-0007", Name = "John Stones",      GPA = 3.5m,  IsActive = false },
            new() { RegistrationNumber = "TMS-2026-0008", Name = "Kayl Walker",      GPA = 1.5m,  IsActive = true  },
            new() { RegistrationNumber = "TMS-2026-0009", Name = "Tewodros Abiyu",    GPA = 3.5m,  IsActive = true  },
            new() { RegistrationNumber = "TMS-2026-0010", Name = "Mesfin Abeje",      GPA = 3.3m,  IsActive = true  },
            new() { RegistrationNumber = "TMS-2026-0011", Name = "Eden Mogos",        GPA = 3.4m,  IsActive = false },
            new() { RegistrationNumber = "TMS-2026-0012", Name = "Yasin Tahir",       GPA = 3.6m,  IsActive = true  },
            new() { RegistrationNumber = "TMS-2026-0013", Name = "Muluken Showa",     GPA = 3.7m,  IsActive = false },
            new() { RegistrationNumber = "TMS-2026-0014", Name = "Azmeraw Tefera",    GPA = 3.7m,  IsActive = true  },
            new() { RegistrationNumber = "TMS-2026-0015", Name = "Tesema Melaku",     GPA = 2.9m,  IsActive = false },
            new() { RegistrationNumber = "TMS-2026-0016", Name = "Demelash Ayele",    GPA = 3.1m,  IsActive = true  },
            new() { RegistrationNumber = "TMS-2026-0017", Name = "Leyikun Mekonin",   GPA = 2.5m,  IsActive = false },
            new() { RegistrationNumber = "TMS-2026-0018", Name = "John Smith",        GPA = 3.4m,  IsActive = true  },
            new() { RegistrationNumber = "TMS-2026-0019", Name = "John Stones",      GPA = 3.3m,  IsActive = false },
            new() { RegistrationNumber = "TMS-2026-0020", Name = "Look Shaw",         GPA = 2.2m,  IsActive = true  },
            new() { RegistrationNumber = "TMS-2026-0021", Name = "Dagim Sisay",       GPA = 3.63m, IsActive = false },
            new() { RegistrationNumber = "TMS-2026-0022", Name = "Elsa Berihun",      GPA = 3.73m, IsActive = true  },
            new() { RegistrationNumber = "TMS-2026-0023", Name = "Eliyas Tamiru",     GPA = 3.83m, IsActive = false },
            new() { RegistrationNumber = "TMS-2026-0024", Name = "Yonatan Ejigu",     GPA = 3.8m,  IsActive = true  },
            new() { RegistrationNumber = "TMS-2026-0025", Name = "Estifanos Sisay",   GPA = 2.4m,  IsActive = false },
        };
